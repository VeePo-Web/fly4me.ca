...
import { ArrowRight, ArrowLeft, MessageCircle, HelpCircle, UserCheck } from "lucide-react";
import ScrollReveal from "@/components/ScrollReveal";

const allLinks = [
  { to: "/faith/get-connected", label: "Get Connected", icon: UserCheck },
  { to: "/faith/questions", label: "Faith Questions", icon: HelpCircle },
  { to: "/faith/contact-pastor", label: "Contact a Church", icon: MessageCircle },
];
...
const FaithNav = () => {
  ...
  return (
    <ScrollReveal delay={0.15}>
      <nav aria-label="Continue exploring faith" className="border-t border-border/40 pt-10 mt-4">
        <div className="mb-8 animate-[fade-in_0.4s_cubic-bezier(0.16,1,0.3,1)_both]">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-foreground">Exploring Faith</p>
              <p className="text-[10px] text-muted-foreground truncate">Questions, connections, and conversations</p>
            </div>
          </Link>
        </div>

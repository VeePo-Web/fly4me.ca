...
import { ArrowRight, ArrowLeft, Compass, Users, BookOpen, Church } from "lucide-react";
import ScrollReveal from "@/components/ScrollReveal";

const allLinks = [
  { to: "/vision/mission", label: "Vision & Mission", icon: Compass },
  { to: "/vision/unity", label: "Unity Across Churches", icon: Users },
  { to: "/vision/church-history", label: "Church History", icon: BookOpen },
  { to: "/vision/partners", label: "Partnered Churches", icon: Church },
];
...
const VisionNav = () => {
  ...
  return (
    <ScrollReveal delay={0.15}>
      <nav aria-label="More about our vision" className="border-t border-border/40 pt-10 mt-4">
        <div className="mb-8 animate-[fade-in_0.4s_cubic-bezier(0.16,1,0.3,1)_both]">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-foreground">Vision</p>
              <p className="text-[10px] text-muted-foreground truncate">The heart behind the day</p>
            </div>
          </Link>
        </div>

...
import { ArrowRight, ArrowLeft, Calendar, Backpack, Cloud, Car, Utensils, ShieldCheck, Accessibility } from "lucide-react";
import ScrollReveal from "@/components/ScrollReveal";

const allLinks = [
  { to: "/day-details/schedule", label: "Schedule", icon: Calendar },
  { to: "/day-details/what-to-bring", label: "What to Bring", icon: Backpack },
  { to: "/day-details/weather", label: "Weather", icon: Cloud },
  { to: "/day-details/parking-map", label: "Parking & Map", icon: Car },
  { to: "/day-details/food-trucks", label: "Food Trucks", icon: Utensils },
  { to: "/day-details/guidelines", label: "Guidelines", icon: ShieldCheck },
  { to: "/day-details/accessibility", label: "Accessibility", icon: Accessibility },
];
...
const DayDetailsNav = () => {
  ...
  return (
    <ScrollReveal delay={0.15}>
      <nav aria-label="More day details" className="border-t border-border/40 pt-10 mt-4">
        <div className="mb-8 animate-[fade-in_0.4s_cubic-bezier(0.16,1,0.3,1)_both]">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-foreground">Day Details</p>
              <p className="text-[10px] text-muted-foreground truncate">All event logistics in one place</p>
            </div>
          </Link>
        </div>
